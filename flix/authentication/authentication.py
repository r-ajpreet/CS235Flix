...
def login():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            # Authenticate user.
            services.authenticate_user(user['username'], form.password.data, repo.instance)
            ...
            # Username not knonw to the system, set a suitable error message.
            username_not_recognised = "Username not recognised - please enter another"
...
class PasswordValid:
    def __init__(self, message=None):
        if not message:
            message = u'Your password must be at least 8 characets, and contain an upper case letter,\'' \
                      u'a lower case letter and a digit'
